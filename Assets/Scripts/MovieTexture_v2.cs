...
Usage:
	...
	Add the MovieTexture_v2.cs script to the surface object.
...
Implementation:
	In the MovieTexture_v2 Awake() call, GetNativeTextureID() is called on 
...
public class MovieTexture_v2 : MonoBehaviour
{
	...
	AndroidJavaObject StartVideoPlayerOnTextureId(int textureId)
	{
		...
		mediaPlayer.Call("setDataSource", "/storage/emulated/0/Movies/Scene_1_Take_8_SF.mp4");
		//mediaPlayer.Call("setDataSource", "/storage/emulated/0/Movies/Scene_1_Take_8_S1F.mp4");
