...
public class MoviePlayerSample : MonoBehaviour
{
	...
	void DelayedStartVideo()
	{
		if (!startedVideo)
		{
			...
			mediaPlayer = StartVideoPlayerOnTextureId(nativeTextureID, "/storage/emulated/0/Movies/Scene_2_Take_2_S.mp4");
#endif
		}
	}
	...
	public void PlayVideo1 () {
		#if (UNITY_ANDROID && !UNITY_EDITOR)
		StartVideoPlayerOnTextureId(nativeTextureID, "/storage/emulated/0/Movies/Scene_2_Take_2_S.mp4");
		#endif
	}
	...
	public void PlayVideo2 () {
		#if (UNITY_ANDROID && !UNITY_EDITOR)
		StartVideoPlayerOnTextureId(nativeTextureID, "path to the video2");
		#endif
	}
