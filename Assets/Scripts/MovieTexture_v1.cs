...
Usage:
	...
	Add the MovieTexture_v1.cs script to the surface object.
...
Implementation:
	...
	In the MovieTexture_v1 Awake() call, GetNativeTextureID() is called on 
...
public class MovieTexture_v1 : MonoBehaviour
{
	...
	void DelayedStartVideo()
	{
		if (!startedVideo)
		{
			...
			mediaPlayer = StartVideoPlayerOnTextureId(nativeTextureID, "/storage/emulated/0/Movies/Scene_1_Take_8_SF.mp4");
#endif
		}
	}
	...
	void Start()
	{
		...
		Invoke("DelayedStartVideo", 0.1f); //testing
#endif
	}
	...
	public void PlayVideo2 () {
		...
		mediaPlayer = StartVideoPlayerOnTextureId(nativeTextureID, "/storage/emulated/0/Movies/Scene_1_Take_8_S1F.mp4");
		#endif
	}
	...
	/// </summary>
	AndroidJavaObject StartVideoPlayerOnTextureId(int textureId, string filepath)
	{

		Debug.Log("SetUpVideoPlayer " + filepath);
